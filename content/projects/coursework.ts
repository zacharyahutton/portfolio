...
export const courseworkProjects: Project[] = [

  {
    ...
    image: "/case-studies/ds-bst-lab-cover.svg",
...

  {
    ...
    image: "/case-studies/db-library-cover.svg",
...

  {
    ...
    stack: ["Python", "Algorithms", "Benchmarking"],
    image: "/case-studies/prog-fund-algorithms-cover.svg",
...

  {
    ...
    stack: ["Networking", "Security Policy", "Linux"],
    image: "/case-studies/cyber-network-cover.svg",
