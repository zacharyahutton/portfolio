...
/* ================================
   ...
   if ($('.testimonial-slider').length > 0) {
    ...
    if($('.project-inner-slider').length > 0) {
        /* ZH: tighter centered slides so covers fit and stay centered */
        ...
        try {
          var _zhEl = document.querySelector(".project-inner-slider");
          if (_zhEl) _zhEl.setAttribute("data-zh-inner", "1");
        } catch (e) {}
    }
